                ...
                <div class="col-lg-8">
                    ...
                    <div class="lr-wrap tab-content"  data-aos="zoom-in" data-aos-duration="500">
                        ...
                        <?php
                            ...
                            <?php endif ?>
                            <form class="register-form" method="post" id="register-form" action="myaccount/updatepassword" name="from_url"  enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="re-password" class="form-control" name="password" placeholder="Re-enter New Password" required>
                                            <span><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 511.974 511.974" style="enable-background:new 0 0 511.974 511.974;" xml:space="preserve">
                                                <g>
                                                    <g>
                                                        <g>
