											...
											<div class="panel-body">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-md-6">
															<input id="phone" name="phone" type="text" placeholder="Phone" class="form-control input-md" style="padding: 0px 12px;margin-top: 6px !important;">
														</div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													<div class="form-group">
														...
														<div class="col-md-6">
															<textarea rows="4" id="message" name="message" placeholder="Message" class="form-control" style="padding: 20px 12px;height: 80px !important;margin-top: 6px !important;"></textarea>
														</div>
													</div>
												</div>
												<div class="row">
