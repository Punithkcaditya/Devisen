...
class MY_Controller extends CI_Controller {
    ...
    public function __construct() {
        ...
        parent::__construct();
        //this is for getting the browser info code
        $this->reset();
        $this->determine();
        //this is for getting the browser info code
        ...
        if (!empty($_SERVER['HTTP_REFERER']) && empty($_SESSION['reference_url'])) {
            $reference = $_SERVER['HTTP_REFERER']; //echo "<pre/>"; print_r($REFERER); die();
            $_SESSION['reference_url'] = $reference;
            $reference_url = $reference;
            $base_url = parse_url(base_url());
            if (empty($_SESSION['reference_url']) && ($reference['host'] == $base_url['host'])) {
        ...
        if (!empty($_SERVER['HTTP_REFERER'])) {
            $REFERER = parse_url($_SERVER['HTTP_REFERER']); //echo "<pre/>"; print_r($REFERER); die();
            $_SESSION['from'] = $REFERER['host'];
        }
        $this->settings = $this->settings_model->view();
        $this->phrases = $this->phrases_model->view();
        $this->data['settings'] = $this->settings;
        $this->data['phrases'] = $this->phrases;

        $this->preview = $this->input->post('preview', TRUE);
...
//              $this->data['widgetarea_' . $area_id] = $widgets;
    ...
    // check browser code begins here
    private $_agent = '';
