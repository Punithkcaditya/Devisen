...
<section class="lr-section gird-section" style="padding-top: 250px;">
    <h3>Login</h3>
        <div class="container">
		    ...
		    <?php
                    ...
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#login" role="tab" aria-controls="nav-home" aria-selected="true">Login</a>
