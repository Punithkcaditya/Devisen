<section class="content">
    <div class="row">
        <div class="box box-info">
            ...
            <div class="container">
                <!-- Horizontal Form -->
                <form class="form-horizontals"  method="post" id="user_form" name="user_form" action="<?php echo $this->class_name; ?>/category_save" enctype="multipart/form-data">
                    <input type="hidden" name="report_category_id" value="<?php echo (!empty($query->report_category_id)) ? $query->report_category_id : "" ?>"/>
                    <div class="container">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    <input type="text" name="category_name" id="category_name" class="form-control" placeholder="Category Name" value="<?php echo (!empty($query->category_name)) ? $query->category_name : '' ?>"   data-validation="required" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
                                                <textarea  name="category_desc" id="category_desc" rows="5" class="form-control " placeholder="Category Description" data-validation="required"><?php echo (!empty($query->category_desc)) ? $query->category_desc : '' ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-2">
                                                <div class="form-group">
                                                    <label for="page_title">Sort Order :</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group">
