<section class="content">
    <form method="post" action="">
        ...
        <?php endif ?> 
        <p class="pull-right"><a href='<?php echo $this->class_name; ?>/report_add'>Add Report</a></p> 
		</br>
		<br/>
        <div class="row">
                                        ...
                                        <?php if (!empty($query)):
                                            ...
                                            <?php foreach ($query as $row): ?>
                                                <tr>
													...
													<td align="center">
                                                            <a href='<?php echo $this->class_name; ?>/report_edit/<?php echo $row->report_id; ?>'><i class="fa fa-pencil" title="Edit" aria-describedby="ui-id-4"></i></a>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a href='<?php echo $this->class_name; ?>/report_delete/<?php echo $row->report_id; ?>' title="Delete"><i class="fa fa-trash" title="Delete" aria-describedby="ui-id-4"></i></a>
