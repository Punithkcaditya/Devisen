<section class="content">
    <div class="row">
        <div class="box box-info">
            ...
            <div class="container">
                <!-- Horizontal Form -->
                <form class="form-horizontals" method="post" id="user_form" name="user_form" action="<?php echo $this->class_name; ?>/address_save" enctype="multipart/form-data">
                    <input type="hidden" name="address_id" value="<?php echo (!empty($query->address_id)) ? $query->address_id : "" ?>"/>
                    <div class="container">
                            ...
                            <div class="col-xs-11 col-sm-11 col-md-11 col-sm-offset-2 col-md-offset-0">
                                <div class="panel panel-default">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-3 col-sm-3 col-md-3">
                                                <div class="form-group">
                                                    <label for="page_title">Address Name :</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <div class="form-group">
                                                <textarea  name="address" id="address" rows="5" class="form-control ckeditor" placeholder="Page Content" data-validation="required"><?php echo (!empty($query->address)) ? $query->address : '' ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="box-footer">
                                        <a href="<?php echo $this->class_name; ?>/address_list" class="btn btn-warning">Cancel / Back</a>
