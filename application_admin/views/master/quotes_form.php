<section class="content">
    <div class="row">
        <div class="box box-info">
            ...
            <div class="container">
                <!-- Horizontal Form -->
                <form class="form-horizontals" method="post" id="user_form" name="user_form" action="<?php echo $this->class_name; ?>/quotes_save" enctype="multipart/form-data">
                    <input type="hidden" name="quotes_id" value="<?php echo (!empty($query->quotes_id)) ? $query->quotes_id : "" ?>"/>
                    <div class="container">
                            ...
                            <div class="col-xs-11 col-sm-11 col-md-11 col-sm-offset-2 col-md-offset-0">
                                <div class="panel panel-default">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-3 col-sm-3 col-md-3">
                                                <div class="form-group">
                                                    <label for="page_title">Quotes Name :</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <div class="form-group">
                                                    <input type="text" name="quotes_text" id="quotes_text" class="form-control" placeholder="quotes Name" value="<?php echo (!empty($query->quotes_text)) ? $query->quotes_text : '' ?>"   data-validation="required" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-3 col-sm-3 col-md-3">
                                                <div class="form-group">
                                                    <label for="page_content">Quotes Author :</label>
                                                </div>
                                            </div>
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <div class="form-group">
                                                <input type="text" name="author" id="author" class="form-control" placeholder="Author" value="<?php echo (!empty($query->author)) ? $query->author : '' ?>"   data-validation="required" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="box-footer">
                                        <a href="<?php echo $this->class_name; ?>/quotes_list" class="btn btn-warning">Cancel / Back</a>
