<section class="content">
    <form method="post" action="">
        ...
        <?php endif ?> 
        <p class="pull-right"><a href='<?php echo $this->class_name; ?>/commentry_add'>Add commentry Master</a></p>   
		</br>
		<br/>
        <div class="row">
                                    ...
                                    <tbody>
                                        <?php if (!empty($query)):
                                            ...
                                            <?php foreach ($query as $row): ?>
                                                <tr>
                                                    <td><?php echo $sno; ?></td>
													<td><?php echo $row->commentry_text; ?></td>
													...
													<td align="center">
														<a href='<?php echo $this->class_name; ?>/commentry_edit/<?php echo $row->commentry_id; ?>'><i class="fa fa-pencil" title="Edit" aria-describedby="ui-id-4"></i></a>
                                                        &nbsp;&nbsp;&nbsp;&nbsp;<a href='<?php echo $this->class_name; ?>/commentry_delete/<?php echo $row->commentry_id; ?>' title="Delete"><i class="fa fa-trash" title="Delete" aria-describedby="ui-id-4"></i></a>
